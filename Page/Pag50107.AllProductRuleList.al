        ...
        area(Processing)
        {
            action(UP)
            {
                ...
                begin
                    ...
                    if recRuleMatrix.FindSet() then begin
                        repeat
                            cuSwapPriority.MovePriorityUp(recRuleMatrix, 0);
            ...
            action(Down)
            {
                ...
                begin
                    ...
                    if recRuleMatrix.FindSet() then begin
                        repeat
                            cuSwapPriority.MovePriorityDown(recRuleMatrix, 0);
